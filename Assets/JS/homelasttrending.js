document.addEventListener("DOMContentLoaded", async () => {
    ...
    try {
        ...
        const response = await fetch('/Assets/json_files/trending_product.json');
        ...
        topThreeProducts.forEach(product => {
            ...
            productCard.innerHTML = `
                ...
                <div class="card_img p-1">
                    <a href="product-details.html?product-id=${productId}&category-file=trending_product.json" class="product-details-link" data-id="${productId}" data-category="trending_product.json">
        ...
        container.addEventListener('click', (event) => {
            const button = event.target.closest('.LastCardAddButton');
            if (button) {
