document.addEventListener("DOMContentLoaded", async () => {
    ...
    try {
        ...
        const response = await fetch('/Assets/json_files/top_sell_products.json');
        ...
        topThreeProducts.forEach(product => {
            ...
            productCard.innerHTML = `
                ...
                <div class="card_img p-1">
                    <a href="product-details.html?product-id=${productId}&category-file=top_sell_products.json" class="product-details-link" data-id="${productId}" data-category="top_sell_products.json">
